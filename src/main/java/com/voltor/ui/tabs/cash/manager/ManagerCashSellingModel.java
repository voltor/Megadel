...
@Component
public class ManagerCashSellingModel {
	...
	void clearFields() {
		...
		user.clear();
		masterData.clear();
		masterData = sellingService.getForManagerCash();
		updateFilteredData();
	}
	...
	void updateByCash(TransferCashEntity cash) {
			clearFields(); 
			masterData = sellingService.getForManagerCash(cash);
			updateFilteredData();
